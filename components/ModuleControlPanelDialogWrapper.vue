...
defineExpose({
  open: () => {
    console.log('[ModuleControlPanelDialogWrapper] Opening dialog, current value:', dialogOpen.value);
    dialogOpen.value = true;
    console.log('[ModuleControlPanelDialogWrapper] After setting, value is:', dialogOpen.value);
  },
  close: () => {
